  ...
  return (
    <div>
        ...
        <div className='w-[1440px] h-[1144px]'>
          ...
          <p className='w-[644px] h-[48px] text-base text-center text-[#9F9F9F] ml-96 mt-5'>For More Information About Our Product & Services. Please Feel Free To Drop Us An Email. Our Staff Always Be There To Help You Out. Do Not Hesitate!</p>
          </div>
          <div className='w-[1058px] h-[923px] flex justify-around ml-48'>
          {/*left side*/}
